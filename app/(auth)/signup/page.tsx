...
export default function SignupPage() {
  ...
  const strengthColor = ['', '#ff4444', '#ffaa00', '#88cc00', '#00cc66'][strength];
  ...
  return (
    <div>
      <div style={{ marginBottom: 40 }}>
        <div className="tag" style={{ marginBottom: 16 }}>Join BIGBOLD</div>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        <div>
          <label style={{ color: 'var(--bb-muted)', fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', display: 'block', marginBottom: 8 }}>Full Name</label>
        ...
        <div>
          <label style={{ color: 'var(--bb-muted)', fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', display: 'block', marginBottom: 8 }}>Password</label>
          ...
          {form.password.length > 0 && (
            <div style={{ marginTop: 8 }}>
              <div style={{ display: 'flex', gap: 4, marginBottom: 4 }}>
                {[1,2,3,4].map(i => (
                  <div key={i} style={{ flex: 1, height: 3, background: i <= strength ? strengthColor : 'var(--bb-border)', transition: 'background 0.3s' }} />
                ))}
              </div>
        ...
        <div>
          <label style={{ color: 'var(--bb-muted)', fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', display: 'block', marginBottom: 8 }}>Confirm Password</label>
          ...
          {form.confirm && form.confirm !== form.password && (
            <p style={{ color: '#ff4444', fontSize: 11, marginTop: 4 }}>Passwords don't match</p>
          )}
        </div>

        <p style={{ color: 'var(--bb-subtle)', fontSize: 12, lineHeight: 1.6 }}>
          By creating an account you agree to our{' '}
          <a href="#" style={{ color: 'var(--bb-fg)', textDecoration: 'underline' }}>Terms of Service</a>
          {' '}and{' '}
          <a href="#" style={{ color: 'var(--bb-fg)', textDecoration: 'underline' }}>Privacy Policy</a>.
        </p>
