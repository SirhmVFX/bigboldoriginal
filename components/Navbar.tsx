  ...
  return (
    <>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 74 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
            ...
            <button onClick={toggle} aria-label="Toggle theme" style={{
              width: 40, height: 22,
              background: isDark ? 'var(--bb-fg)' : 'var(--bb-border)',
        ...
        {/* Mobile menu */}
        {menuOpen && (
          <div style={{ background: 'var(--bb-bg)', borderTop: '1px solid var(--bb-border)', padding: '24px', display: 'flex', flexDirection: 'column', gap: 0 }}>
            {[
              { label: 'Shop', href: '/products' },
              { label: 'About', href: '/about' },
              { label: 'Contact', href: '/contact' },
